...
namespace Ex04.Menus.Interfaces
{
    public class MainMenu
    {
        ...
        public void Show()
        {
            ...
            while (!toExit)
            {
                ...
                if (!isValidChoice(choice, currentMenu.Items.Count))
                {
                    ...
                    pressAnyKeyToContinueWithoutClear();
                    continue;
                }
                ...
                if (selectedItem is SubMenuItem selectedSubMenu)
                {
                    currentMenu = selectedSubMenu;
                }
                else
                {
                    Console.Clear();
        ...
        private static void pressAnyKeyToContinueAndClear()
        {
            Console.WriteLine();
        ...
        private static void pressAnyKeyToContinueWithoutClear()
        {
            Console.WriteLine("Press any key to continue...");
            Console.ReadKey(true);
        }
